...
public class PostMapperImpl implements PostMapper {
    ...
    @Override
    public Post modelToEntity(PostDTO postDTO, CycleAvoidingMappingContext context) {
    ...
    @Override
    public PostDTO entityToModel(Post post, CycleAvoidingMappingContext context) {
    ...
    protected Comment commentDTOToComment(CommentDTO commentDTO, CycleAvoidingMappingContext context) {
        ...
        comment.setPost( modelToEntity( commentDTO.getPost(), context ) );
    ...
    protected List<Comment> commentDTOListToCommentList(List<CommentDTO> list, CycleAvoidingMappingContext context) {
        ...
        for ( CommentDTO commentDTO : list ) {
            list1.add( commentDTOToComment( commentDTO, context ) );
        }
    ...
    protected CommentDTO commentToCommentDTO(Comment comment, CycleAvoidingMappingContext context) {
        ...
        commentDTO.setPost( entityToModel( comment.getPost(), context ) );
    ...
    protected List<CommentDTO> commentListToCommentDTOList(List<Comment> list, CycleAvoidingMappingContext context) {
        ...
        for ( Comment comment : list ) {
            list1.add( commentToCommentDTO( comment, context ) );
        }
